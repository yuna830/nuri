...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Predict senior health status with a trained sklearn model.")
    parser.add_argument("--input", required=True, help="CSV or JSON file for prediction rows.")
    parser.add_argument("--model", default="artifacts/health_status_model.joblib", help="Trained joblib model path.")
