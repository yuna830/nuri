...
export const mapWelfareSenior = (item) => ({
    ...
    heart: item.heartDisease ?? item.heart,
    joint: item.jointDisease ?? item.joint,
    stroke: item.stroke,
    kidney: item.kidneyDisease ?? item.kidney,
    lung: item.lungDisease ?? item.respiratoryDisease ?? item.lung,
    liver: item.liverDisease ?? item.liver,
    cancer: item.cancer,
    walkingAid: item.walkingAid,
    dementia: item.dementia,
    vision: item.vision,
    hearing: item.hearing,
    recentFall: item.recentFall,
    hasSurgery: item.hasSurgery,
